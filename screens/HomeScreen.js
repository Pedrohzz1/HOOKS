...
export default function HomeScreen({ navigation }) {
  ...
  const consoles = [
    { id: 'ps5', nome: 'PS5', preco: 'R$ 4.299', img: require('../assets/ps5.png') },
    { id: 'xboxseriesx', nome: 'Xbox Series X', preco: 'R$ 4.199', img: require('../assets/xboxseriesx.png') },
    { id: 'xboxseriess', nome: 'Xbox Series S', preco: 'R$ 2.649', img: require('../assets/xboxseriess.png') },
    { id: 'xboxbranco', nome: 'Xbox Series X 2TB', preco: 'R$ 6.199', img: require('../assets/xboxbranco.png') },
    { id: 'ps5pro', nome: 'PS5 Pro', preco: 'R$ 6.137', img: require('../assets/ps5pro.png') },
    { id: 'ps4', nome: 'PS4', preco: 'R$ 1.639', img: require('../assets/ps4.png') },
  ];
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, dark ? styles.dark : styles.light]}>
      ...
      <Text style={[styles.title, dark && styles.textDark]}>
        Seja Bem-vindo aos Pecinhas Consoles!
      </Text>
      ...
      <Text style={[styles.greeting, dark && styles.textDark]}>
        Olá, {name || 'jogador'}!
      </Text>
      ...
      >
        <Text style={[styles.buttonText, dark && styles.textDark]}>
          Gerenciar Jogos no Carrinho
        </Text>
      </Pressable>
    </ScrollView>
  );
